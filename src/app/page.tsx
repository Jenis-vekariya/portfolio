...
export default function Home() {
  ...
  const handleLayoutClick = (e: MouseEvent<HTMLDivElement>, layout: (typeof blogLayouts)[0] | (typeof postLayouts)[0], gridRef: React.RefObject<HTMLDivElement>) => {
    if (layout.comingSoon || !gridRef.current) {
        setActiveBanner(null);
        return;
    };

    if (activeBanner && activeBanner.name === layout.name) {
      setActiveBanner(null);
      return;
    }
