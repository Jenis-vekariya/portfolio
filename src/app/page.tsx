...
const postLayouts = [
  { name: 'Full Hero Image', description: 'A bold, image-forward design.', imageUrl: 'https://placehold.co/600x450.png', imageHint: 'hero image' },
  { name: 'Minimal Post', description: 'Content-focused with clean typography.', imageUrl: 'https://placehold.co/600x450.png', imageHint: 'minimalist content' },
  { name: 'Wide Hero', description: 'Expansive header for dramatic effect.', imageUrl: 'https://placehold.co/600x450.png', imageHint: 'wide hero' },
  { name: 'Default Post', description: 'A classic and balanced layout.', imageUrl: 'https://placehold.co/600x450.png', imageHint: 'classic layout' },
  { name: 'Split Screen', description: 'Side-by-side content and imagery.', imageUrl: 'https://placehold.co/600x450.png', imageHint: 'split screen' },
  { name: 'Author Focus', description: 'Highlights the writer and their bio.', imageUrl: 'https://placehold.co/600x450.png', imageHint: 'author profile' },
];
